...
static void ShowDemoWindowWidgets()
{
    ...
    {
        IMGUI_DEMO_MARKER("Widgets/Text Other/Multi-line Text Input");
        ...
        IMGUI_DEMO_MARKER("Widgets/Text Other/Filtered Text Input");
        ...
        IMGUI_DEMO_MARKER("Widgets/Text Other/Password input");
        ...
        IMGUI_DEMO_MARKER("Widgets/Text Other/Completion, History, Edit Callbacks");
        ...
        IMGUI_DEMO_MARKER("Widgets/Text Other/Resize Callback");
        ...
        IMGUI_DEMO_MARKER("Widgets/Text Other/Miscellaneous");
